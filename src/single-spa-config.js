...
singleSpa.registerApplication(
    ...
    'singleDemo',
    async () => {
        // await runScript('http://127.0.0.1:8081/bundle.js');
        // await runScript('http://127.0.0.1:8081/10.bundle.js');
        // // await runScript('http://127.0.0.1:8081/js/app.js');
        // // eslint-disable-next-line no-console
        // console.log(window.singleVue, 'window.singleVue');
        // return window.singleVue;
        let singleVue = null;
        await getManifest('/reactJson/mainfest.json', 'bundle').then(() => {
            // eslint-disable-next-line no-console
    ...
    location => location.pathname.startsWith('/react-antd') // 配置微前端模块前缀
);
